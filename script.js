...
function showCookieBanner() {
  ...
  style.innerHTML = `
    .cookie-banner {
      ...
      width: 90%;
      max-width: 760px;
      background: color-mix(in srgb, var(--editorial-white, #fffefa) 96%, transparent);
      backdrop-filter: blur(12px);
      -webkit-backdrop-filter: blur(12px);
      border: 1px solid var(--editorial-line, rgba(16, 28, 42, 0.15));
      border-left: 4px solid var(--editorial-warm, #cf784f);
      border-radius: 4px;
      box-shadow: 12px 12px 0 rgba(16, 28, 42, 0.12);
    ...
    .cookie-banner-text h3 {
      ...
      font-weight: 600;
      color: var(--editorial-ink, #101c2a);
      margin: 0 0 0.5rem 0;
    }
    .cookie-banner-text p {
      font-size: 0.76rem;
      color: var(--editorial-muted, #647184);
      line-height: 1.65;
      margin: 0;
    }
    .cookie-banner-btns {
    ...
    .cookie-accept {
      background-color: var(--editorial-ink, #101c2a);
      color: white;
      border: none;
    }
    .cookie-accept:hover {
      background-color: var(--editorial-ink-2, #183047);
    ...
    .cookie-reject:hover {
      background-color: transparent;
      border-color: var(--editorial-ink, #101c2a);
      color: var(--editorial-ink, #101c2a);
    }
    .cookie-info {
      background-color: transparent;
      color: var(--editorial-accent, #2364d8);
      border: none;
    ...
    @media (max-width: 480px) {
      .cookie-banner {
        ...
        padding: 1.15rem;
        box-shadow: 7px 7px 0 rgba(16, 28, 42, 0.12);
      }
      .cookie-banner-btns {
        flex-direction: column;
        align-items: stretch;
...
function initFormHandler() {
  ...
  form.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      alert('No hemos podido enviar tu solicitud. Revisa tu conexión e inténtalo de nuevo. Si continúa el problema, escribe a tutormatepro@gmail.com.');
      if (submitButton) {
