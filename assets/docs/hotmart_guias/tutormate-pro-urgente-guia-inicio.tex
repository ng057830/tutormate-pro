...
\begin{titlepage}
    ...
    {\huge \color{accent} \textbf{Preparación Urgente / PAU (10 clases)}} \\[0.8cm]
    {\Large \color{gold} \textbf{Guía de Inicio y Bienvenida}} \\[1.5cm]
    
    \begin{minipage}{0.8\textwidth}
        \centering
        \large \color{primary} Preparación al sprint para selectividad y objetivos con fecha próxima
    \end{minipage} \\[2cm]
...
\begin{itemize}
    \item 10 sesiones online individuales en vivo al sprint.
    \item Enfoque directo en el formato, estructura y temario específico de la prueba.
    \item Resolución de exámenes de selectividad oficiales de años anteriores.
    \item Estrategias de optimización de tiempo del examen y descarte de preguntas.
    \item Acceso a pizarra digital y esquemas conceptuales rápidos en PDF.
\end{itemize}
...
\color{white}\textbf{Sesión} & \color{white}\textbf{Enfoque de Trabajo} \\ \hline
 Clase 1 & Diagnóstico rápido del formato oficial del examen, prioridades y temas de mayor peso. \\ \hline
 Clase 2 & Estrategias y resolución de problemas del primer bloque oficial (e.g., Análisis Matemático). \\ \hline
 Clase 3 & Práctica dirigida de ejercicios reales de selectividad del bloque de Análisis. \\ \hline
 Clase 4 & Estrategias y resolución de problemas del segundo bloque oficial (e.g., Álgebra Lineal). \\ \hline
 Clase 5 & Práctica dirigida de ejercicios reales de selectividad del bloque de Álgebra. \\ \hline
 Clase 6 & Estrategias y resolución de problemas del tercer bloque oficial (e.g., Geometría o Probabilidad). \\ \hline
 Clase 7 & Resolución dirigida de problemas mixtos de exámenes de años anteriores en convocatorias reales. \\ \hline
 Clase 8 & Simulacro de examen completo simulando condiciones y tiempos reales de la prueba. \\ \hline
 Clase 9 & Corrección minuciosa del simulacro según rúbricas de evaluación oficiales. \\ \hline
 Clase 10 & Repaso final de dudas al sprint, consejos prácticos para el día de la prueba y motivación. \\ \hline
\end{tabular}
