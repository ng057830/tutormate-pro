...
\begin{titlepage}
    ...
    {\huge \color{accent} \textbf{Universidad / Estadística (10 clases)}} \\[0.8cm]
    {\Large \color{gold} \textbf{Guía de Inicio y Bienvenida}} \\[1.5cm]
    
    \begin{minipage}{0.8\textwidth}
        \centering
        \large \color{primary} Acompañamiento individual para nivel universitario y estadística avanzada
    \end{minipage} \\[2cm]
...
Este plan de \textbf{10 clases de nivel Universitario o Estadística} está estructurado para abordar asignaturas cuantitativas avanzadas de alta exigencia académica. Se enfoca en dotar al estudiante del rigor formal necesario, asimilando teoremas y demostraciones, resolviendo boletines prácticos de la facultad, y dominando la interpretación de resultados y software si aplica.
...
\begin{itemize}
    \item 10 sesiones online individuales en vivo de nivel avanzado.
    \item Enfoque teórico-práctico riguroso y conceptualmente intuitivo.
    \item Resolución paso a paso de boletines de prácticas de tu universidad.
    \item Compartición y soporte para salidas de software si aplica (Python / R).
    \item Acceso a pizarra digital y apuntes consolidados en PDF.
\end{itemize}
...
\color{white}\textbf{Sesión} & \color{white}\textbf{Enfoque de Trabajo} \\ \hline
 Clase 1 & Revisión detallada de la guía docente de tu universidad, boletines actuales y nivelación. \\ \hline
 Clase 2 & Aclaración de conceptos teóricos abstractos y teoremas fundamentales. \\ \hline
 Clase 3 & Resolución de problemas teóricos de desarrollo y demostraciones típicas. \\ \hline
 Clase 4 & Ejercicios prácticos de aplicación directa del primer bloque de la materia. \\ \hline
 Clase 5 & Abordaje de la parte práctica con software estadístico o métodos de cálculo avanzados. \\ \hline
 Clase 6 & Resolución dirigida de exámenes de convocatorias anteriores de tu facultad. \\ \hline
 Clase 7 & Análisis de casos complejos e interpretación detallada de resultados numéricos. \\ \hline
 Clase 8 & Simulacro de examen universitario simulando condiciones reales de evaluación. \\ \hline
 Clase 9 & Corrección minuciosa del simulacro, pulido de la redacción matemática y rúbrica. \\ \hline
 Clase 10 & Repaso final de dudas de última hora y consejos para el examen universitario. \\ \hline
\end{tabular}
