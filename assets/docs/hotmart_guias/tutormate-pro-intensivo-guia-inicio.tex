...
\begin{titlepage}
    ...
    {\huge \color{accent} \textbf{Plan Intensivo (24 clases)}} \\[0.8cm]
    {\Large \color{gold} \textbf{Guía de Inicio y Bienvenida}} \\[1.5cm]
    
    \begin{minipage}{0.8\textwidth}
        \centering
        \large \color{primary} Programa de recuperación de base, refuerzo de verano y trimestre completo
    \end{minipage} \\[2cm]
...
El \textbf{Plan Intensivo de 24 clases} es nuestro programa más completo. Está diseñado específicamente para alumnos que necesitan una reestructuración de sus bases académicas, prepararse para convocatorias extraordinarias (como exámenes de recuperación de septiembre), cursar un intensivo durante el verano, o disponer de un soporte semanal continuo de alto nivel durante todo un trimestre escolar o universitario.
...
\begin{itemize}
    \item 24 sesiones online individuales en vivo.
    \item Planificación y ruta detallada para todo el período de estudios.
    \item Pizarra digital y material didáctico interactivo a color.
    \item Entrega de apuntes consolidados y boletines de ejercicios resueltos.
    \item Soporte prioritario vía email para resolución de dudas cortas entre clases.
    \item Informes periódicos opcionales de avance y diagnóstico para la familia.
\end{itemize}
...
\color{white}\textbf{Sesión} & \color{white}\textbf{Enfoque de Trabajo} \\ \hline
 Clases 1-4 & Evaluación detallada, nivelación de bases matemáticas iniciales y corrección de lagunas operativas. \\ \hline
 Clases 5-10 & Desarrollo conceptual y resolución guiada de problemas del primer bloque principal. \\ \hline
 Clases 11-16 & Desarrollo del segundo bloque principal y combinación de ejercicios mixtos. \\ \hline
 Clases 17-20 & Práctica intensiva sobre boletines oficiales y exámenes de convocatorias reales. \\ \hline
 Clases 21-22 & Simulacros de exámenes completos cronometrados en tiempo real. \\ \hline
 Clases 23-24 & Revisión de simulacros, resolución de últimas dudas y recomendaciones de examen. \\ \hline
\end{tabular}
