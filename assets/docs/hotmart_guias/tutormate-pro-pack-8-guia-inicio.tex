...
\begin{titlepage}
    ...
    {\huge \color{accent} \textbf{Pack 8 clases}} \\[0.8cm]
    {\Large \color{gold} \textbf{Guía de Inicio y Bienvenida}} \\[1.5cm]
    
    \begin{minipage}{0.8\textwidth}
        \centering
        \large \color{primary} Acompañamiento individualizado y preparación estructurada de exámenes
    \end{minipage} \\[2cm]
...
Este \textbf{Pack de 8 clases} proporciona el espacio ideal para realizar un seguimiento semanal continuo. Es la opción más recomendada para afianzar conceptos, corregir lagunas de base y asimilar el temario con suficiente práctica y antelación al examen.
...
\begin{itemize}
    \item 8 sesiones online individuales en vivo.
    \item Explicación paso a paso de conceptos teóricos y prácticos.
    \item Uso de pizarra digital interactiva compartida.
    \item Materiales y apuntes de clase en formato PDF.
    \item Boletines y ejercicios complementarios de refuerzo.
    \item Seguimiento continuo de la evolución del estudiante durante el paquete.
\end{itemize}
...
\color{white}\textbf{Sesión} & \color{white}\textbf{Enfoque de Trabajo} \\ \hline
 Clase 1 & Diagnóstico inicial de bases, establecimiento de metas y temas clave. \\ \hline
 Clase 2 & Nivelación y refuerzo de conceptos básicos del primer bloque temático. \\ \hline
 Clase 3 & Ejercicios prácticos guiados paso a paso de nivel medio. \\ \hline
 Clase 4 & Abordaje del segundo bloque temático y análisis de problemas tipo. \\ \hline
 Clase 5 & Resolución de ejercicios complejos y corrección de fallos comunes. \\ \hline
 Clase 6 & Consolidación de métodos de cálculo y álgebra aplicada. \\ \hline
 Clase 7 & Simulacro de examen enfocado en la estructura oficial de la prueba. \\ \hline
 Clase 8 & Revisión final, corrección del simulacro, consejos y pautas de examen. \\ \hline
\end{tabular}
